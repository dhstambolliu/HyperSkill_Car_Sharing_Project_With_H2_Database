...
public class DatabaseHandler {
    ...
    static String DB_URL = "jdbc:h2:C:\\Users\\dhstambolliu\\IdeaProjects\\Car Sharing\\Car Sharing\\task\\src\\carsharing\\db\\";
    static final String USERNAME = "dhstambolliu";
    static final String PASSWORD = "dhstambolliu";
        ...
        try {
            ...
            try (Connection connection = DriverManager.getConnection(DB_URL)) {
                ...
                try (Statement statement = connection.createStatement()) {
                    ...
                    if (count > 0) {
                        String listQuery = "SELECT * FROM CAR LEFT JOIN CUSTOMER ON CAR.ID = CUSTOMER.RENTED_CAR_ID WHERE COMPANY_ID = " + companyId + " AND CUSTOMER.RENTED_CAR_ID is null; ";
                        res = statement.executeQuery(listQuery);
                ...
                try (Statement statement = connection.createStatement()) {
                    ...
                    while (customer.next()) {
                        ...
                        if (customer.getObject(3) != null) {
                            ...
                            ArrayList<Company> companies = DatabaseHandler.obtainCompanyList();
                            ...
                            if (companies.size() == 0) {
                                ...
                                ArrayList<Car> carList = DatabaseHandler.obtainCarList(companyId);
